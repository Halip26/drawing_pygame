...
pygame.display.set_caption("Drawing Pygame")
...
while running:
    ...
    black_color_button = pygame.draw.circle(
        toolbar, BLACK, (240, 25), color_button_width // 2
    )  # Black color button
    red_color_button = pygame.draw.circle(
        toolbar, RED, (280, 25), color_button_width // 2
    )  # Red color button
    yellow_color_button = pygame.draw.circle(
        toolbar, YELLOW, (320, 25), color_button_width // 2
    )  # Yellow color button
    blue_color_button = pygame.draw.circle(
        toolbar, BLUE, (360, 25), color_button_width // 2
    )  # Blue color button
    ...
    for event in pygame.event.get():
        if event.type == QUIT:
            ...
            pygame.draw.line(
                ...
                color,
                last_pos,
                (event.pos[0], event.pos[1] - TOOLBAR_HEIGHT),
                brush_size,
            )
